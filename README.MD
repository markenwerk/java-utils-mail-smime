__Be aware:__ This project is no longer maintained. Have a look at [Simple Java Mail](https://github.com/simple-java-mail/java-utils-mail-smime) if you're interested in a successor project.
